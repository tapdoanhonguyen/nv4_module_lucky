...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i>Vòng quay may mắn</h3> 
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th>Tên chương trình quay thưởng</th>
                    <th>Hình ảnh</th>
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <td> 
                    <a href="{VIEW.image}" title="{VIEW.name}" target="blank">
                        <img src="{VIEW.image}" title="{VIEW.name}" alt="{VIEW.name}" height="70px">
                    </a>
                </td>
                ...
                <td>
                    ...
                    <div>
                        <a href="{VIEW.addprize}">Thêm giải thưởng</a>
                    </div>
                    <div>
                        <!-- BEGIN: da_chon -->
                        <span style="color: red;">
                            Đã chọn làm chương trình mặc định
                        </span>
                        <!-- END: da_chon -->
                        <!-- BEGIN: chua_chon -->
                        <button type="button" class="" onclick="set_default({VIEW.id});">
                            Chọn làm chương trình mặc định
                        </button>
                        <!-- END: chua_chon -->
                    </div>
                </td>
...
<script type="text/javascript">
 ...
 function duyet(id){
    $.ajax({
        type : 'POST',
        url: script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '={OP}&mod=duyet&id=' + id,
        contentType: false,
        processData: false,
        success : function(res){
            res2=JSON.parse(res);
