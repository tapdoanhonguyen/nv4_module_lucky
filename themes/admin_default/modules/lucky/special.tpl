...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i>Người may mắn</h3> 
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th>Tên người may mắn</th>
                    <th>Giải thưởng may mắn</th>
                    <th>Chương trình quay thưởng</th>
                    <th>Số giải còn lại</th>
                    <th>Số giải đã quay trúng</th>
                    <th>Hành động</th>
                </tr>
            </thead>
            <!-- BEGIN: generate_page -->
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <td> 
                     {VIEW.user_info.first_name} {VIEW.user_info.last_name}
                 </td>
                 <td>
                    {VIEW.prize_info.title}
                    
                </td>
                 <td>
                    {VIEW.lucky_info.name}
