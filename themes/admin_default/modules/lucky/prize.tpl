...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i>Giải thưởng</h3> 
        <div class="pull-right">
            ...
            <a title="Thêm giải thưởng" data-toggle="tooltip" data-placement="top"class="btn btn-success btn-sm" href="{LINK_ADD}"><i class="fa fa-plus" aria-hidden="true"></i></a> 
        </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                   ...
                   <td> 
                       <a href="{VIEW.image}" title="{VIEW.title}">
                           <img src="{VIEW.image}" title="{VIEW.title}" alt="{VIEW.title}" height="70">
                       </a>
                   </td>
                   <td> 
                     {VIEW.percent} %
